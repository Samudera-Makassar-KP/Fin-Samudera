    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 mb-4">
                <h3 className="text-xl font-medium dark:text-gray-100">Semua Pengajuan LPJ Bon Sementara</h3>
            ...
            {loading ? (
                ...
                <div className="w-full overflow-x-auto">
                    <div className="inline-block min-w-[1150px] w-full">
                        <table className="w-full bg-white dark:bg-gray-800 border dark:border-gray-600 rounded-lg text-sm dark:text-gray-200">
                            <thead>
                                <tr className="bg-gray-100 dark:bg-gray-700 text-left dark:text-gray-100">
                                    ...
                                    <th className="px-4 py-2 border dark:border-gray-600">Kategori LPJ BS</th>
                            ...
                            <tbody>
                                {filteredData.map((item, index) => (
                                    <tr key={item.id}>
                                        ...
                                        <td className="px-4 py-2 border dark:border-gray-600">
                                            Rp{(item.jumlahBS || 0).toLocaleString('id-ID')}
                                        </td>
        ...
        const fetchUserAndLpj = async () => {
            ...
            try {
                ...
                if (userRole === 'Super Admin') {
                    ...
                    // 'Dibatalkan' sama sekali di file ini. Rules isElevatedRole() di
                    // firestore.rules sudah mendukung list broad ini.
                    const allSnapshot = await getDocs(collection(db, 'lpj'))
                                        ...
                                        <table className="min-w-full bg-white dark:bg-gray-800 border dark:border-gray-600 rounded-lg text-sm dark:text-gray-200">
                                            <thead>
                                                <tr className="bg-gray-100 dark:bg-gray-700 text-left dark:text-gray-100">
                                                    ...
                                                    <th className="px-4 py-2 border dark:border-gray-600">Nomor Dokumen</th>
                                                    <th className="px-4 py-2 border dark:border-gray-600">Nama</th>
                                                    <th className="px-4 py-2 border dark:border-gray-600">Kategori LPJ</th>
                                                    <th className="px-4 py-2 border dark:border-gray-600">Nomor BS</th>
                                                    <th className="px-4 py-2 border dark:border-gray-600">Jumlah BS</th>
                                                    <th className="px-4 py-2 border dark:border-gray-600">Tanggal Pengajuan</th>
                                            ...
                                            <tbody>
                                                {filteredApprovedData.lpj.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="p-4 border dark:border-gray-600">{item.nomorBS}</td>
                                                        <td className="p-4 border dark:border-gray-600">
                                                            Rp{item.jumlahBS.toLocaleString('id-ID')}
                                                        </td>
                                                        <td className="p-4 border dark:border-gray-600">
