...
const FormBs = () => {
    ...
    // Bagian AN: catatan wajib diisi editor (Admin/Validator/Reviewer/Super
    // Admin) saat mengedit pengajuan MILIK ORANG LAIN -- jadi jejak "kesalahan
    // apa yang diperbaiki" tersimpan di statusHistory, bukan cuma teks generik
    // "Super Admin mengedit detail form ...".
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (isEditMode) {
                ...
                // (diisi dari editData.user, lihat useEffect auto-fill di atas),
                // BUKAN uid editor yang sedang login -- pakai localStorage
                // langsung supaya statusHistory mencatat SIAPA SEBENARNYA yang
                // melakukan perubahan (bug lama: entri edit selalu tercatat
                // seolah-olah pengaju mengedit pengajuannya sendiri).
                ...
                {isEditMode && (
                    <div className="mt-4">
                        ...
                        <textarea
                            ...
                            placeholder="Jelaskan kesalahan/perubahan yang diperbaiki pada pengajuan ini, mis. 'Nominal Jumlah BS salah ketik, diperbaiki sesuai kuitansi asli'"
                            value={editNote}
